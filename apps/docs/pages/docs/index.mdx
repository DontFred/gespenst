...
using TSUP to bundle the code. The components are based on shandcn/ui, it's
using primitives from Radix and styled with Tailwind. So it's customizable and
